  ...
  return (
    <VirtuosoDataTable
      className={cn(
        ...
        '[--data-table-bg:var(--background)]',
        '[--data-table-border:var(--border)]',
        '[--data-table-fg:var(--foreground)]',
        '[--data-table-muted:var(--muted)]',
        '[--data-table-muted-fg:var(--muted-foreground)]',
        '[--data-table-row-hover:color-mix(in_oklch,var(--muted)_50%,var(--background))]',
        '[--data-table-sticky-hover:color-mix(in_oklch,var(--muted)_50%,var(--background))]',
