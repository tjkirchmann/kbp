      ...
      <div className="flex items-center gap-2 flex-wrap">
        {canRetry && (
          <button
            ...
            className={`${pillBase} text-primary border-primary/40 hover:bg-primary/10`}
          >
            Retry
          </button>
        )}
        {canCancel && (
          <button
            ...
            className={`${pillBase} text-destructive border-destructive/40 hover:bg-destructive/10`}
          >
            Cancel
          </button>
        )}
