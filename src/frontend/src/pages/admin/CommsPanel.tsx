      ...
      <div className="flex flex-col gap-4 pt-2 border-t border-border/20">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">Listens for slash commands &amp; messages, and posts.</span>
          </div>
          <button
            type="button"
            role="switch"
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-xs text-muted-foreground">Where commands are allowed and where bot notifications &amp; test posts go.</p>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className={INPUT_CLASS}
          />
          <p className="text-xs text-muted-foreground">Comma-separated channels the message listener acts on.</p>
        </div>

        <p className="text-xs text-muted-foreground">
          The bot token &amp; guild id are set via env (<code>DISCORD_BOT_TOKEN</code>, <code>DISCORD_GUILD_ID</code>).
          The listener also needs Message Content Intent enabled in the Discord Developer Portal.
        </p>
      </div>
