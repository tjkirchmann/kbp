...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('submissions_open', sa.Boolean(), server_default='false', nullable=False),
    ...
    op.create_index('ix_pool_submissions_submitted_by_user_id', 'pool_submissions', ['submitted_by_user_id'])
    ...
    op.create_index('ix_pool_submission_game_items_submission_id', 'pool_submission_game_items', ['submission_id'])
    op.create_index('ix_pool_submission_game_items_pool_game_id', 'pool_submission_game_items', ['pool_game_id'])
