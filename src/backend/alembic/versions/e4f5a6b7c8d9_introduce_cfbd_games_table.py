...
def upgrade() -> None:
    ...
    op.drop_index(
        ...
        table_name="pool_submission_game_items",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "start_time_tbd", sa.Boolean(), nullable=False, server_default="false"
        ),
        ...
        sa.Column(
            "conference_game", sa.Boolean(), nullable=False, server_default="false"
        ),
