...
class Pool(Base):
    ...
    submissions_open: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    submissions_due_at: Mapped[datetime | None] = mapped_column(nullable=True)
    scoring_strategy: Mapped[ScoringStrategy | None] = mapped_column(
        Enum(ScoringStrategy, name="scoring_strategy"), nullable=True
    )
    password_hash: Mapped[str | None] = mapped_column(String, nullable=True)
    deleted_at: Mapped[datetime | None] = mapped_column(nullable=True)

    games: Mapped[list["PoolGame"]] = relationship(
...
class PoolSubmissionGameItem(Base):
    ...
    pool_game_id: Mapped[int] = mapped_column(
        ForeignKey("pool_games.id"), nullable=False, index=True
    )
