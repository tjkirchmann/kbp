...
class AdminNotifyConfig(Base):
    ...
    notify_on_start: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
    ...
    run_catchup: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
    # Defer this task once when the app boots (independent of cron/catch-up).
    run_on_startup: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
    ...
    hide_in_history: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
